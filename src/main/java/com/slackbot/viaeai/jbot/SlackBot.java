...
public class SlackBot extends Bot {
    ...
    public void onReceiveDM(WebSocketSession session, Event event) {
         ...
         com.slackbot.viaeai.viaeaibotMessage.Message message = messageMapper.mapEventToViaeaiMessage(event);
        logger.debug("mapping incoming event message to custom messageTYpe");
        try {
